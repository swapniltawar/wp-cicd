...
<main class="legal-info">
    <div class="container">
       
        <div class="details-body">
            <article class="article">
                <h2 class="heading-two">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum</h2>
            ...
            <!--  -->
            <article class="article">
                <h2 class="heading-two">Sed ut perspiciatis unde omnis iste natus error sit voluptatem</h2>
                <div class="article__body">
                    <p class="content-para">
