...
class new_arcticle_widget extends WP_Widget {

    function __construct() {
        parent::__construct(
        'new_arcticle_widget',
        __('New Articles Widget', 'onxrp'),
        array( 'description' => __( 'OnXRP new articles', 'onxrp' ), )
        );
    }
