...
<main>
    <section class="featured-article">
        <div class="container">
            <div class="page-title">
                <h1 class="lined-title"><?php  single_cat_title('' , true );?> </h1>
    ...
    <section class="sub-articles sub-articles-full odd-row">
        <div class="container sub-articles--container">
            <div class="article-title d-flex align-items-center">
                <img src="<?php echo  esc_url(THEMEURI); ?>/assets/images/title-icon.svg" alt="onXRP" /><?php  single_cat_title('' , true );?> <?php echo"Articles";?>
            </div>
                ...
                <?php  if (  $i < $total_posts ) {
                    ...
                    <div class="section-load-more d-flex rellax" data-rellax-speed="2" data-rellax-xs-speed=".8" data-rellax-mobile-speed=".3" data-rellax-tablet-speed=".7" data-rellax-desktop-speed="2">
                        <div class="big-cta d-flex">
                            ...
                            <a href="javascript:void(0);" class="btn round-primary onxrp_loadmore" data-maxpage="'.$the_query1->max_num_pages.'" data-catid="'.$cat_ID.'" data-posttype="post">
                                <span>Load More</span>
