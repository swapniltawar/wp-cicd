...
/**
 * Php version 7.4
 * Template Name: Podcast Category
 *
 * @category ONXRP
 * @package  ONXRP
...
<main>
    ...
    <section class="featured-article">
        <div class="container">
            <div class="page-title">
                <h1 class="lined-title"><?php echo $category_name;?> </h1>
                ...
                <?php
                    ...
                    <div class="section-load-more d-flex rellax" data-rellax-speed="2" data-rellax-xs-speed=".8" data-rellax-mobile-speed=".3" data-rellax-tablet-speed=".7" data-rellax-desktop-speed="2">
                        <div class="big-cta d-flex">
                            ...
                            <a href="javascript:void(0);" class="btn round-primary onxrp_loadmore" data-catid="'.$cat_ID.'" data-maxpage="'.$the_query1->max_num_pages.'" data-posttype="podcast" data-taxonomy ="'.$taxonomy.'" >
                                <span>Load More</span>
    ...
    <h1 class="lined-title">No Post Found</h1>
</div>';
    }
    ?>
</main>
