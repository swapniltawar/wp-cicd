...
scp -i ~/.ssh/mark4-qa-server-cemtrexlabs.pem onxrp.zip ubuntu@13.52.136.49:/home/ubuntu/wordpress/onxrp_stage/wp-content/themes

ssh -i ~/.ssh/mark4-qa-server-cemtrexlabs.pem ubuntu@13.52.136.49 << EOF
  pwd
  cd wordpress/onxrp_stage/wp-content/themes
  pwd
  ls -alh
...
# scp -i ~/.ssh/mark4-qa-server-cemtrexlabs.pem /home/swapnil/Projects/onxrp/plugins/advanced-custom-fields-pro.zip ubuntu@13.52.136.49:/home/ubuntu/wordpress/onxrp_stage/wp-content/plugins
